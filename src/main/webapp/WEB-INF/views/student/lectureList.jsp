		...
		-->
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li><a href="menteeList?id=${studentInfo[0].student_id}">
		    	                                ...
		    	                                <div id="lecture_${status.count}" class="panel-collapse collapse">
		    	                                	<div class="panel-body">
		    	                                    	<ul class="nav">
															...
															<li><a href="redirectstudentLecture?student_id=${studentInfo[0].student_id}&course_id=${row.course_id}">2. 퀵폴만들기</a></li>
